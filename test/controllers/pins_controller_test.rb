...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { budget: @pin.budget, description: @pin.description, flexible: @pin.flexible }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { budget: @pin.budget, description: @pin.description, flexible: @pin.flexible }
    assert_redirected_to pin_path(assigns(:pin))
  end
